...
int main()
{
  ...
  (fp_text value Centertouch (at 6.25 -3) (layer F.Fab)\n\
	...
	MakeSpin( 0*3.14159/180.0, 100*3.14159/180.0, 120 * 3.14159 / 180.0, 28, 20, 2 );
	MakeSpin( 120*3.14159/180.0, 220*3.14159/180.0, 120 * 3.14159 / 180.0, 28, 20, 2 );
	MakeSpin( 240*3.14159/180.0, 340*3.14159/180.0, 120 * 3.14159 / 180.0, 28, 20, 2 );
